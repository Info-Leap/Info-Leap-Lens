...
from oxdata.skills.domain_kb import get_facts_as_context
from oxdata.skills.qual_retriever import search_qual_trees
from oxdata.config.project_1 import DATA_DICTIONARY, BENCHMARKS
from oxdata.skills.bq3_engine import BQ3AnalyticalEngine
from oxdata.skills.thinker import classify_complexity, plan_query, build_session_context
from oxdata.skills.capabilities.insights import get_benchmark_context, build_enriched_prompt
from oxdata.skills.capabilities.compare import should_compare, build_comparison
from oxdata.skills.semantic_router import router
...
def resolve_pronouns(question: str, history: List[Dict],
    ...
    try:
        from oxdata.config.project_1 import DIMENSIONS
...
async def run_autonomous_research_async(question: str, message_history: List[Dict] = None, session_id: str = "default_session", active_cat="All", active_brand="All Brands") -> AsyncGenerator[dict, None]:
    try:
        ...
        try:
            from oxdata.skills.memory_service import memory as lens_memory
        ...
        async def run_sql(ctx: RunContext[ResearchDeps], instruction: str) -> str:
            ...
            from oxdata.skills.capabilities import REGISTRY
        ...
        async def get_brand_health_context(
            ...
            try:
                from oxdata.skills.brand_health_skill import summarise_for_agent, get_brand_health_data
                ...
                if "error" not in raw:
                    ...
                    from oxdata.skills.brand_health_skill import get_multi_brand_comparison
                ...
                try:
                    from oxdata.skills.brand_health_skill import summarise_for_agent as _sfa
        ...
        async def statistical_significance(ctx: RunContext[ResearchDeps],
            ...
            try:
                from oxdata.skills.analytics_tools import significance_test
        ...
        async def perceptual_map(ctx: RunContext[ResearchDeps],
            ...
            try:
                from oxdata.skills.analytics_tools import correspondence_analysis
        ...
        async def imagery_profile(ctx: RunContext[ResearchDeps],
            ...
            try:
                from oxdata.skills.analytics_tools import brand_imagery_profile
        ...
        async def driver_regression(ctx: RunContext[ResearchDeps],
            ...
            try:
                from oxdata.skills.analytics_tools import key_driver_regression
        ...
        async def segment_difference_test(ctx: RunContext[ResearchDeps],
            ...
            try:
                from oxdata.skills.analytics_tools import segment_anova
