...
from oxdata.skills.example_store import example_store
from oxdata.skills.schema_registry import get_registry
from oxdata.skills.capabilities import REGISTRY as SKILL_REGISTRY
from oxdata.researcher_agent import FinalReport
...
async def run_deterministic_async(
    ...
    if chart_type_bh:
        ...
        try:
            from oxdata.skills.chart_tools import get_brand_chart
            q = question.lower()
