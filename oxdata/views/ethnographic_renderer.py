...
from oxdata.utils.ui_styles import (
    COLORS, CHART_LAYOUT, kpi_card, empty_state, section_header,
)
from oxdata.config.project_1 import MIXER_SECTION_LABELS as _ETH_SIGNAL_MAP
...
def _render_consumer_profiles(matrices: list, findings_dir: str, call_or: Callable) -> None:
    ...
    if nps_rows:
        ...
        from oxdata.skills.prompt_templates import build_methodology_note
...
def _render_brand_landscape(matrices: list, findings_dir: str, call_or: Callable) -> None:
    ...
    # not per-chart).
    from oxdata.views.chart_adapter import render_counts
...
def _render_options_menu(proj_id: str, call_llm_fn: Callable) -> list[str]:
    ...
    """
    from oxdata.skills.prompt_templates import build_options_menu_prompt
...
def render_ethnographic(proj: dict, base_path: Path,
    ...
    from oxdata.skills.project_extractor import gate_matrices_by_quality
